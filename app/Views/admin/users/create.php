...
$subtitle = 'Create a new authenticated ' . strtolower(htmlspecialchars($activeRole)) . ' account with assigned institutional access privileges.';
...
<div class="card shadow-sm border-0 mb-4" style="border: 1px solid #e2e8f0 !important; border-radius: 6px; max-width: 760px;">
    <div class="card-header bg-white py-3 border-bottom d-flex justify-content-between align-items-center">
        ...
        <span class="badge badge-<?= strtolower($activeRole) ?>"><?= htmlspecialchars($activeRole) ?></span>
    </div>
    ...
    <form method="POST" action="<?= url('/admin/users') ?>">
        ...
        <div class="card-body p-4">
            ...
            <div class="mb-3">
                ...
                <div class="form-text">Temporary password will be generated and emailed here.</div>
            </div>
            ...
            <?php if ($activeRole === 'Student'): ?>
                ...
                <div class="row g-3 mb-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-text">Active class set cohort.</div>
                    </div>
                </div>
