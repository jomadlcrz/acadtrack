            ...
            <div class="table-responsive">
                <table class="table table-hover align-middle mb-0">
                    <thead class="table-light border-bottom">
                        <tr>
                            <th class="fw-semibold text-muted small py-3 px-3">Subject</th>
                            <th class="fw-semibold text-muted small py-3 px-3">Instructor</th>
                            <th class="fw-semibold text-muted small py-3 px-3">Period</th>
